  ...
  constructor(props) {
       ...
       
   {
        ...
        },
        {
          ...
          comment: `That's my <a href="https://github.com/SPeshov" target="_blank">Github</a>`
        },
        {
          id: 7,
          label: "React",
        ...
        },
        {
          ...
          comment: `I've built some websites using it. Like  
            <a href="https://majesticbunny.com/" target="_blank">this</a> one or 
            <a href="http://walnuttma.com/" target="_blank">that</a> one.`
        },
        {
          id: 17,
          label: "Node.js",
          description: `Node.js is an <a href="https://nodejs.org/en/" target="_blank">open-source</a>, cross-platform JavaScript run-time environment that executes JavaScript code server-side`,
          comment: `I'm building my first project with it, see playground.`
        },
        {
          id: 55,
          label: "PHP",
